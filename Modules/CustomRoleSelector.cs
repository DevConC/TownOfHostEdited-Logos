...
internal class CustomRoleSelector
{
    ...
    EndOfAssign:
        ...
        if (!Options.DisableHiddenRoles.GetBool())
        {
            ...
            if (rd.Next(0, 100) < 50 && rolesToAssign.Remove(CustomRoles.Sans)) rolesToAssign.Add(CustomRoles.Bard);
			if (rd.Next(0, 100) < 50 && rolesToAssign.Remove(CustomRoles.Terrorist)) rolesToAssign.Add(CustomRoles.Konan);
        }
